...
<div class="container">
    <div class="row">
        <div class="span12" style="text-align: center;">
            <p class="lead"  style="font-size: 25px;"><i class="icon-dashboard"></i> <br/>Reporting développement durable,
                <abbr title="Bilan Gaz à Effet de Serre (réglementaire)">BGES</abbr>, bilan carbone, énergie, eau,
                déchets, <abbr title="Qualité, Hygiène, Sécurité, Environnement">QHSE</abbr>,
                <abbr title="Responsabilité Sociale et Environnementale">RSE</abbr>&nbsp;:
                <br/><span class="text-success">My C-Tool s'adapte à votre besoin.</span></p>
            <p  class="lead" style="font-size: 25px;"><i class="icon-sitemap"></i>  <br/>Grande entreprise, PME, fédération de métier, collectivité,
    ...
    <div class="row">
        <div class="span6">
            ...
            <h2><i class="icon-random"></i> Évolutif</h2>
            <p>Indicateurs, structure organisationnelle, axes d’analyses, formulaires de collecte, référentiels&nbsp;: dans My C-Tool
