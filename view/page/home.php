...
<div class="container">
    ...
    <div class="row">
        <div class="span6">
            <h2>Générique</h2>
            <p>Grande entreprise, PME, fédération de métier, collectivité, établissement public&nbsp;: My C-Tool
                s'adapte à votre structure.</p>
            <p>Projet, événement, produit, service, procédé&nbsp;: My C-Tool s'adapte à votre périmètre de suivi.</p>
            <p>Reporting développement durable,
                ...
                My C-Tool s'adapte à votre besoin.</p>
        </div>
        <div class="span6">
            <h2>Évolutive</h2>
