	...
	<header id="header">
      ...
      <div class="logo">
        ...
        <?php if($theme1272_logo){?>
          <a href="<?php bloginfo('url'); ?>/"><img src="http://www.myc-sense.com/wp-content/uploads/2012/04/logo-my-c-sense2.jpg" alt="My C-Sense, vous aider à compter ce qui va compter" title="<?php bloginfo('description'); ?>"></a>
        <?php } else { ?>
      ...
      <a href="<?php bloginfo('url'); ?>/wp-login.php" id="login-link">Connexion client</a>
      <?php if ( get_option('theme1272_searchbox') == 'true') { ?>  
        <div id="top-search">
          <form method="get" action="<?php echo get_option('home'); ?>/">
            <input type="text" name="s"  class="input-search" placeholder="Recherche" />
          </form>
        </div>  
      <?php } ?>
